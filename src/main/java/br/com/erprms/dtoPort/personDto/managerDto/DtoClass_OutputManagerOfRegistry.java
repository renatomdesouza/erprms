...
@Getter
public class DtoClass_OutputManagerOfRegistry {
	...
	public DtoClass_OutputManagerOfRegistry(PersonEntity person, ManagerEmployeePersonQualificationSubclass manager) {
