...
public class FullTimeEmployeeController {
	...
	public ResponseEntity<DtoClass_FullTimeEmployeeRegistryOutput> register(
		...
		var dtoRecordToOutputManagerOfRegistry_With_Uri = 
				personQualifPost.registerService(FULL_TIME_EMPLOYEE, managerRecord, uriComponentsBuilder);
	...
	public ResponseEntity<Page<DtoClass_FullTimeEmployeeListing>> listing(
		...
		return ResponseEntity
				.ok(personQualifGet.listingService(FULL_TIME_EMPLOYEE, qualificationPageable));
	}
